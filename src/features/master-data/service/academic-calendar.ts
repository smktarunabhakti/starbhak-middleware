...
import { createAcademicCalendar, deleteAcademicCalendar, getAcademicCalendarById, getAcademicCalendarByUuid, getAllAcademicCalendar, updateAcademicCalendar } from "../../../common/model/academic-calender-model";
...
const fetchAcademicCalendarById = async (id: number): Promise<ServiceResponse> => {
    try{
...
const fetchAcademicCalendarByUuid = async (uuid: string): Promise<ServiceResponse> => {
    try{
...
const addAcademicCalendar = async (
    createData: {
        name: string;
        start_date: string;
        end_date: string;
...
const editAcademicCalendar = async (
    ...
    try{
        ...
        console.info("[Service] existingAcademicCalendar: ", existingAcademicCalendar);
        ...
        const updatedDataAcademicCalendar = updateAcademicCalendar(uuid,updateData);
        return{
            success: true,
...
const removeAcademicCalendar = async (uuid: string): Promise<ServiceResponse> => {
    try{
